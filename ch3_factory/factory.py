...
class Connector(object):
    ...
    __metaclass__ = abc.ABCMeta #Declares class as abtract class

    def __init__(self,is_secure):
        self.is_secure = is_secure
        self.port = self.port_factory_method()
        self.protocol = self.protocol_factory_method() # dynamic allocation

    @abc.abstractmethod
    def parse(self):
        """ Parse web content. This method should be redefined in runtime"""
        pass
...
class FTPConnector(Connector):
    ...
    def parse(self,content):
        ...
        filenames = []
        for line in lines:
            # The FTP format typically has 8 coloumns, split them
...
if __name__ == "__main__":
    ...
    try:
        ...
        print 'Can not access resource with thid method'
    else:
